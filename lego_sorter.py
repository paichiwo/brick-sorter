...
def main():
    ...
    part_name_label.place(x=121, y=228, width=300)

    part_year_label = Label(text="(1982, 2023)", justify="center", font=("Manrope", 11, 'bold'), bg=colors[1], fg='white', height=1)
    part_year_label.place(x=121, y=247, width=300)

    part_year_label = Label(text="Bricklink", justify="center", font=("Manrope", 11, 'bold'), bg=colors[1], fg='white', height=1)
    part_year_label.place(x=121, y=266, width=300)
